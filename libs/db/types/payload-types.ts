...
export interface Config {
  ...
  collections: {
    ...
    challenge: Challenge;
    'challenge-prize': ChallengePrize;
  ...
  collectionsSelect: {
    ...
    'challenge-prize': ChallengePrizeSelect<false> | ChallengePrizeSelect<true>;
...
export interface Challenge {
   ...
   */
  'challenge-host'?: (number | Organization)[] | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "challenge-prize".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "challenge-prize_select".
 */
